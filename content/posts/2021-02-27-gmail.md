...
{{< figure src="/images/gmail/main.png" >}}

{{< figure src="/images/gmail/mail.png" >}}
...
However, if you plan to use multiple accounts with different SMTP servers, it makes more sense to use something like [MSMTP](https://marlam.de/msmtp/msmtp.html) to manage multiple accounts. Here are a couple of examples ([1](https://www.reddit.com/r/emacs/comments/9piml5/a_few_quick_emacsnotmuch_questions/e83zcck?utm_source=share&utm_medium=web2x&context=3), [2](https://www.reddit.com/r/emacs/comments/9piml5/a_few_quick_emacsnotmuch_questions/e84otah?utm_source=share&utm_medium=web2x&context=3)) how to do that.
